...
![](/assets/img/thm/windows/brainstorm/ftp.png)
...
![](/assets/img/thm/windows/brainstorm/mget.png)
...
![](/assets/img/thm/windows/brainstorm/diff.png)
...
![](/assets/img/thm/windows/brainstorm/9999.png)
...
![](/assets/img/thm/windows/brainstorm/fuzz.png)
...
![](/assets/img/thm/windows/brainstorm/41414141.png)
...
![](/assets/img/thm/windows/brainstorm/pattern_create.png)
...
![](/assets/img/thm/windows/brainstorm/restart.png)

![](/assets/img/thm/windows/brainstorm/EIP.png)
...
![](/assets/img/thm/windows/brainstorm/42424242.png)
...
![](/assets/img/thm/windows/brainstorm/follow_in_dump.png)

![](/assets/img/thm/windows/brainstorm/dump.png)
...
![](/assets/img/thm/windows/brainstorm/bytearray.png)
...
![](/assets/img/thm/windows/brainstorm/compare.png)

It seems there are no bad characters (except `0x00` which was initially excluded from our payload)!
...
![](/assets/img/thm/windows/brainstorm/NXCompat.png)
...
![](/assets/img/thm/windows/brainstorm/Symbols.png)
...
![](/assets/img/thm/windows/brainstorm/jmp_esp1.png)

⚠️ **We must ensure that the instruction address does not contain any bad characters** ⚠️

![](/assets/img/thm/windows/brainstorm/jmp_esp2.png)
...
![](/assets/img/thm/windows/brainstorm/reverse_shell.png)
