...
This [room](https://tryhackme.com/room/attackingkerberos) from TryHackMe will cover all of the basics of attacking Kerberos using tools such `Kerbrute`, `Rubeus`, `mimikatz` and `GetUserSPNs.py`/`GetNPUsers.py` from **Impacket**.
...
![](/assets/img/thm/windows/attacking-kerberos/kerberos-auth-overview.png)
...
![](/assets/img/thm/windows/attacking-kerberos/introduction.png)
...
![](/assets/img/thm/windows/attacking-kerberos/kerberoasting.png)
...
![](/assets/img/thm/windows/attacking-kerberos/as-rep-roasting.png)
...
![](/assets/img/thm/windows/attacking-kerberos/tickets.png)
